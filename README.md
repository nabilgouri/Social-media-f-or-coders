...
Since the projject has been built, GitHub has [deprecated authentication via URL query parameters](https://developer.github.com/changes/2019-11-05-deprecated-passwords-and-authorizations-api/#authenticating-using-query-parameters)
...
You can see the full change in [routes/api/profile.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/4be414c6a54994c18397dba9c927ad67b878508b/routes/api/profile.js#L324)

## uuid no longer has a default export

The npm package [uuid](https://www.npmjs.com/package/uuid) no longer has a default export, so in our [client/src/actions/alert.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/actions/alert.js) we need to change the import and use of this package.
...
The EditProfile and CreateProfile have been reduced to one component [ProfileForm.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/profile-forms/ProfileForm.js)  
...
**You can see the implementation of the interceptor and axios instance in [utils/api.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/utils/api.js)**
...
Which also in turn depends on [utils/api.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/utils/api.js)
I would also recommending updating to use a [ redux subscription  ](https://github.com/nabilgouri/Social-media-f-or-coders#redux-subscription-to-manage-local-storage-) to mange setting of the auth token in headers and local storage.
...
Some of you in the course have been having problems installing both packages and meeting peer dependencies.\
 ...
 First create a [ utils/formatDate.js ](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/utils/formatDate.js) file, with the following code...
```js
...
Then in our [Education.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/dashboard/Education.js) component, import the new function...
```js
...
- [Education.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/dashboard/Education.js)
- [Experience.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/dashboard/Experience.js)
- [CommentItem.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/post/CommentItem.js)
- [PostItem.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/posts/PostItem.js)
- [ProfileEducation.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/profile/ProfileEducation.js)
- [ProfileExperience.js](https://github.com/nabilgouri/Social-media-f-or-coders/blob/master/client/src/components/profile/ProfileExperience.js)
